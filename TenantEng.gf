...
-- PN
	...
	mrs_threet	= mkPN( mkN feminine (mkN "Mrs Threet") );
	mr_harris	= mkPN( mkN masculine (mkN "Mr Harris") );
	carl_harris	= mkPN( mkN masculine (mkN "Carl Harris") );
	carl	= mkPN( mkN masculine (mkN "Carl") );
...
-- V
	...
	do_about	= mkV3( mkV "do") noPrep about;
